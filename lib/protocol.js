...
/** True when the payload is a valid typing signal ({ type:'typing', typing:boolean }). */
export function isTypingMessage(data) {
  return !!data && data.type === 'typing' && typeof data.typing === 'boolean';
}
